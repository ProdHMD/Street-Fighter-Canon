...
$rocket_path        = '/srv/users/serverpilot/apps/livesfcanon/web/app/plugins/wp-rocket/';
$rocket_config_path = '/srv/users/serverpilot/apps/livesfcanon/web/app/wp-rocket-config/';
$rocket_cache_path  = '/srv/users/serverpilot/apps/livesfcanon/web/app/cache/wp-rocket/';
...
if ( file_exists( '/srv/users/serverpilot/apps/livesfcanon/web/app/plugins/wp-rocket/inc/classes/dependencies/mobiledetect/mobiledetectlib/Mobile_Detect.php' ) && ! class_exists( 'WP_Rocket_Mobile_Detect' ) ) {
	include_once '/srv/users/serverpilot/apps/livesfcanon/web/app/plugins/wp-rocket/inc/classes/dependencies/mobiledetect/mobiledetectlib/Mobile_Detect.php';
}
